...
import styles from "./SmartSolutions_Autonomous_New.module.css";
            ...
            <>
              ...
              >
                 <div className={styles.tooltipText}>
                  ...
                  <p>Designed to operate seamlessly without the need for human intervention..</p>
                </div> 
              </div>
              ...
              >
                 <div className={styles.tooltipText}>
                  ...
                  <p>Self-driving cars use sensors, cameras, and AI for independent navigation..​</p>
                </div> 
              </div>
              ...
              >
                 <div className={styles.tooltipText}>
                  <h3>Autonomous Industrial Robot</h3>
                  <p>Autonomous service robots are becoming increasingly important across various industries.​</p>
                </div> 
              </div>
              ...
              >
                 <div className={styles.tooltipText}>
                  <h3>Autonomous Service Robot</h3>
                  <p>A self-operating robot designed to assist humans using advanced technologies.​</p>
                </div> 
              </div>
...
export default SmartSolutions_Autonomous_New;