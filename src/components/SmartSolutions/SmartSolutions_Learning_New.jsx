...
import styles from "./SmartSolutions_Learning_New.module.css";
import { useNavigate } from "react-router-dom";
import { Contact } from "../Contact/Contact";
import { Navbar } from "../Navbar/Navbar";
import { useLanguage } from "../../contexts/LanguageContext";
export const SmartSolutions_Learning_New = () => {
      ...
      <section className={styles.container} id="about">
        <div className={styles.content}>
          <div className={styles.imageContainer}>
            ...
            <img
              src={images.smart_solutions_Learning_new_00}
              ...
              <>
                ...
                >
                   <div className={styles.tooltipText}>
                    ...
                    <p>Centralixed platforms for teaching and learning with internet access anytime ,anywhere.</p>
                  </div> 
                </div>
                ...
                >
                   <div className={styles.tooltipText}>
                    <h3>IoT-Enabled Smart Classrooms</h3>
                    <p>Connect and automate classroom devices , enhancing teaching , learning, and management efficiency.</p>
                  </div> 
                </div>
                ...
                >
                   <div className={styles.tooltipText}>
                    <h3>AI-Driven Personallized Learning​</h3>
                    <p>Using AI to customize educational content and methods can enhance learnung outcomes</p>
                  </div> 
                </div>
                ...
                >
                   <div className={styles.tooltipText}>
                    <h3>Professional Assessment and Certificate ​</h3>
                    <p>The process of evaluating professional skills and awarding a certificate upon success.</p>
                  </div> 
                </div>
                ...
                >
                   <div className={styles.tooltipText}>
                    ...
                    <p>A system designed to manage sales processes at retail locations. ​</p>
                  </div> 
                </div> */}
...
export default SmartSolutions_Learning_New;