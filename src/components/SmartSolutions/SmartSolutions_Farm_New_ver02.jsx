...
import styles from "./SmartSolutions_Farm_New_ver02.module.css";
import { useLanguage } from "../../contexts/LanguageContext";

export const SmartSolutions_Farm_New_ver02 = () => {
  ...
  useEffect(() => {
    const handleKeyDown = (event) => {
      if (event.key === 'Escape') {
        if (showImageViewer) {
          setShowImageViewer(false);
          navigate("/smart-solutions-farm_new_ver02");
        } else {
          navigate("/smart-solutions-farm_new");
        }
      }
    };
...
export default SmartSolutions_Farm_New_ver02;