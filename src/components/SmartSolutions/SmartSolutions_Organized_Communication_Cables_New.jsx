...
import styles from "./SmartSolutions_Organized_Communication_Cables_New.module.css";
import { useNavigate } from "react-router-dom";
import { Contact } from "../Contact/Contact";
import { Navbar } from "../Navbar/Navbar";
import { useLanguage } from "../../contexts/LanguageContext";
export const SmartSolutions_Organized_Communication_Cables_New = () => {
...
const handleSectionClick_Ver2 = (section) => {
  ...
  const handleClosePostTutorialImage = () => {
    ...
    navigate("/smart-solutions-organized_communication_cables_new_ver02");
  };
  const handleNext = (e) => {
    e.stopPropagation();
    if (currentStep < tutorialSteps.length - 1) {
...
export default SmartSolutions_Organized_Communication_Cables_New;