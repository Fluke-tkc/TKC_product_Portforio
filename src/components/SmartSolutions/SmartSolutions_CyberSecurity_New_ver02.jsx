...
import styles from "./SmartSolutions_CyberSecurity_New_ver02.module.css";
import { useLanguage } from "../../contexts/LanguageContext";

export const SmartSolutions_CyberSecurity_New_ver02 = () => {
  ...
  useEffect(() => {
    const handleKeyDown = (event) => {
      if (event.key === 'Escape') {
        if (showImageViewer) {
          setShowImageViewer(false);
          navigate("/smart-solutions-cybersecurity_new_ver02");
        } else {
          navigate("/smart-solutions-cybersecurity_new");
        }
      }
    };
...
export default SmartSolutions_CyberSecurity_New_ver02;