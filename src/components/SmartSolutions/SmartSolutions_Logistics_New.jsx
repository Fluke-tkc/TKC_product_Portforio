...
import styles from "./SmartSolutions_Logistics_New.module.css";
import { useNavigate } from "react-router-dom";
import { Contact } from "../Contact/Contact";
import { Navbar } from "../Navbar/Navbar";
import { useLanguage } from "../../contexts/LanguageContext";
export const SmartSolutions_Logistics_New = () => {
      ...
      <section className={styles.container} id="about">
        <div className={styles.content}>
          <div className={styles.imageContainer}>
            ...
            <img
              src={images.smart_solutions_Logistics_new_00}
              ...
              <>
                ...
                >
                   <div className={styles.tooltipText}>
                    <h3> Smart Scan </h3>
                    <p>Devicesquickly scan and decode data for inventory,retail,verification,and customerservice.</p>
                  </div> 
                </div>
                ...
                >
                   <div className={styles.tooltipText}>
                    ...
                    <p>Plans efficient routes by analyzing traffic , weather , and stops , cutting costs</p>
                  </div> 
                </div>
                ...
                >
                   <div className={styles.tooltipText}>
                    <h3>Intelligent Cargo Volume Analysis ​</h3>
                    <p>Cargo Space Detection uses AI and sensors to optimize loading</p>
                  </div> 
                </div>
                ...
                >
                   <div className={styles.tooltipText}>
                    ...
                    <p>TND managers goods transport and delivery , streamlining routes, tracking , and monitoring to boost efficiency and cut costs.</p>
                  </div> 
                </div>
...
export default SmartSolutions_Logistics_New;